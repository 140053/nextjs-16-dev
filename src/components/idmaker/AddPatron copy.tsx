...
export default function AddPatron({ patronData, addUser, addSign, urlDst }: AddPatronProps) {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="space-y-4 lg:w-11/12 mt-3 mb-3">
        ...
        <Input type="text" name="uid" value={formData.id || ""} onChange={handleChange} />
